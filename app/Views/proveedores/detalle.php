<div class="row">
        ...
        <div class="card card-warning mt-2">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= base_url('public/proveedores') ?>" class="btn btn-sm btn-light">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-4">
                <div class="info-box <?= $saldo_actual > 0 ? 'bg-danger' : ($saldo_actual < 0 ? 'bg-info' : 'bg-success') ?>">
                ...
                <table class="table table-hover" id="id_data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <strong class="<?= $saldo_acumulado > 0 ? 'text-danger' : ($saldo_acumulado < 0 ? 'text-info' : 'text-success') ?>">
                    ...
                    <tfoot>
                        <tr class="bg-light">
                            <td colspan="6" class="text-right"><strong>SALDO FINAL:</strong></td>
                            <td class="text-right">
                                <strong class="<?= $saldo_actual > 0 ? 'text-danger' : ($saldo_actual < 0 ? 'text-info' : 'text-success') ?>" style="font-size: 1.2rem;">
